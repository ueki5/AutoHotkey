...
if (LFnKey <> "F14") {
	Hotkey, %LFnKey% & d, Fn_LWin
	Hotkey, %LFnKey% & d up, Fn_LWinUp
}
if (LFnKey <> "F15") {
	Hotkey, %LFnKey% & d, Fn_LAlt
	Hotkey, %LFnKey% & d up, Fn_LAltUp
}
Hotkey, F15 & TAB, AltTab
if (RFnKey <> "F16") {
	Hotkey, %RFnKey% & d, Fn_RControl
	Hotkey, %RFnKey% & d up, Fn_RControlUp
}
if (RFnKey <> "F17") {
	Hotkey, %RFnKey% & d, Fn_RWin
	Hotkey, %RFnKey% & d up, Fn_RWinUp
}
if (RFnKey <> "F18") {
	Hotkey, %RFnKey% & d, Fn_RAlt
	Hotkey, %RFnKey% & d up, Fn_RAltUp
}
Hotkey, F18 & TAB, AltTab

; **********
; 左Fn定義 *
; **********
Hotkey, %LFnKey% & y, Fn_Home
Hotkey, %LFnKey% & h, Fn_Left
Hotkey, %LFnKey% & j, Fn_Down
Hotkey, %LFnKey% & k, Fn_Up
Hotkey, %LFnKey% & i, Fn_Up
Hotkey, %LFnKey% & l, Fn_Right
Hotkey, %LFnKey% & `;, Fn_End
Hotkey, %LFnKey% & n, Fn_PgDn
Hotkey, %LFnKey% & p, Fn_PgUp
; 編集系
Hotkey, %LFnKey% & u, Fn_Escape
Hotkey, %LFnKey% & Space, Fn_Enter
Hotkey, %LFnKey% & b, Fn_Backspace
Hotkey, %LFnKey% & g, Fn_Del
Hotkey, %LFnKey% & ', Fn_Backspace
Hotkey, %LFnKey% & [, Fn_Del
Hotkey, %LFnKey% & ], Fn_Ins
; その他
Hotkey, %LFnKey% & m, Fn_PrintScreen
Hotkey, %LFnKey% & `,, Fn_ScrollLock
; ファンクションキー
